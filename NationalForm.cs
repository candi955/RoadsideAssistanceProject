...
{
    public partial class NationalForm : Form
    {
        public NationalForm()
        {
            InitializeComponent();
        ...
        private void nationalButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                inputfile = File.OpenText(@"nationalList.txt");


                // Read and display the first name.
                nationalInput = inputfile.ReadLine();
                nationalListBox.Items.Clear();
                ...
                while (!inputfile.EndOfStream)
                {
                    ...
                    nationalListBox.Items.Add(nationalInput);
        ...
        private void whatKindTowButton_Click(object sender, EventArgs e)
        {
            ...
            while (int.TryParse(howManyAnswerTextBox.Text, out howMany))
                ...
                try
                {
                    ...
                    outputFile = File.AppendText("nationalTowAnswer.txt");
                    ...
                    MessageBox.Show("This answer was written to nationalTowAnswer.txt");
